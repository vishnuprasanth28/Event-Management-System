...
<body>
    <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="mystocks-tab" data-toggle="tab" href="#mystocks" role="tab" aria-controls="mystocks" aria-selected="true">Profile</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="explore-tab" data-toggle="tab" href="#explore" role="tab" aria-controls="explore" aria-selected="false">Add Venue</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="watchlists-tab" data-toggle="tab" href="#watchlists" role="tab" aria-controls="watchlists" aria-selected="false">Add Vendors</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="mystocks" role="tabpanel" aria-labelledby="mystocks-tab">
                <div class="card">
                    <div class="card-body">
