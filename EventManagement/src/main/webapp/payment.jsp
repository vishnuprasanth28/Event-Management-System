            ...
            <div class="col-md-6">
                ...
                <form id="paymentDetailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="advance" name="advance" value="1000" required>
                    </div>
                    <button type="button" class="btn btn-success" onclick="processPayment()">Pay Advance </button>
                </form>
            </div>
        </div>
